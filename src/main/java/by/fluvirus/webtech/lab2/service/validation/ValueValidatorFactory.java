...
import by.fluvirus.webtech.lab2.service.validation.impl.*;
...
public class ValueValidatorFactory {
    ...
    private ValueValidatorFactory() {
        map.put(List.of(SearchCriteria.TabletPC.COLOR.name()),
                new ColorValidator());
        map.put(List.of(SearchCriteria.Laptop.BATTERY_CAPACITY.name(),
                ...
                new DoubleValidator());
        map.put(List.of(SearchCriteria.Laptop.MEMORY_ROM.name(),
                ...
                new IntValidator());
        map.put(List.of(SearchCriteria.VacuumCleaner.FILTER_TYPE.name()),
                new FilterTypeValidator());
        map.put(List.of(SearchCriteria.Speakers.FREQUENCY_RANGE.name()),
                new RangeValidator());
        map.put(List.of(SearchCriteria.Laptop.OS.name(),
